<template>
  <v-container class=" align-center ">
    <v-sheet class="d-flex main-container justify-center align-center pa-8 mt-16" width="900">
      <div class=" d-flex flex-column ma-8">
        <div v-if="windowWidth <= 1440" class="ma-auto" style="left: 0; right: 0;">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="375" height="284"
            ...
            <g fill="none" fill-rule="evenodd">
              ...
              <path fill="url(#b)" fill-rule="nonzero" d="M0 0v268c0 8.837 7.163 16 16 16h343c8.837 0 16-7.163 16-16V0H0Z"
                mask="url(#c)" />
              <g mask="url(#c)">
                ...
                <g transform="translate(-7.351 95.892)">
                  ...
                  <circle cx="73.754" cy="-18.678" r="85.405" fill="url(#k)" fill-rule="nonzero" mask="url(#l)"
        ...
        <p class="ma-2" color="#3b3e59"> Email Address</p>
        <input type="text-field" hide-details required class="ma-2" placeholder="email@company.com" dense flat>
        <v-btn color="#3b3e59" class="ma-2" height="4rem">subscribe to monthly newsletter</v-btn>

      </div>
      <div class="img-background" v-if="windowWidth > 1440">
